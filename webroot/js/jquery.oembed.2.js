...
(function ($) {
    $.fn.oembed = function (url, options, embedAction) {
		...
		var embedMethod = settings.embedMethod;
        ...
        return this.each(function () {
            ...
            if (embedAction) {
                ...
                settings.onEmbed = function (oembedData, embedMethod) {
					console.log(embedMethod);
                    $.fn.oembed.insertCode(this, embedMethod, oembedData);
                };
            }
            ...
            if (resourceURL != null) {
                ...
                if (provider != null) {
                    ...
                    embedCode(container, resourceURL, provider, embedMethod);
                } else {
    ...
    function embedCode(container, externalUrl, embedProvider, embedMethod) {
        ...
        var requestUrl = getRequestUrl(embedProvider, externalUrl),
			ajaxopts = $.extend({
				...
				success:  function (data) {
					...
					settings.onEmbed.call(container, oembedData, embedMethod);
...
console.log("replace");
            ...
            case "append":
                ...
                break;
			case "annotate":
				var oembedContainer = this.getOembedContainer(container, oembedData);
				oembedContainer.html(oembedData.code);
				container.attr({
